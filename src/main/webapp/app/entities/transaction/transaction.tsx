  ...
  return (
    <div>
      <h2 id="transaction-heading">
        <Translate contentKey="jhipstertestApp.transaction.home.title">Transactions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipstertestApp.transaction.home.createLabel">Create new Transaction</Translate>
        </Link>
      </h2>
          ...
          {transactionList && transactionList.length > 0 ? (
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipstertestApp.transaction.home.notFound">No Transactions found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
