...
export const TransactionDeleteDialog = (props: ITransactionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstertestApp.transaction.delete.question">
        <Translate contentKey="jhipstertestApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
