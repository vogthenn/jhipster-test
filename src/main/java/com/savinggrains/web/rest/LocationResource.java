...
import com.savinggrains.domain.Location;
import com.savinggrains.service.LocationService;
...
/**
 * REST controller for managing {@link com.savinggrains.domain.Location}.
 */
@RestController
@RequestMapping("/api")
