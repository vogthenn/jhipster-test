...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipstertestApp.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipstertestApp.region.delete.question/);
