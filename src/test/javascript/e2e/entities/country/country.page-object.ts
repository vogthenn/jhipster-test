...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipstertestApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipstertestApp.country.delete.question/);
