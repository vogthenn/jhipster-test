...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipstertestApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipstertestApp.location.delete.question/);
